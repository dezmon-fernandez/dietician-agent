...
// Simplify ButtonProps to a union of Link props and Headless Button props
type ButtonProps = {
  ...
  | (Omit<
      ...
      'className' | 'children'
    > & { to: string; href?: never }) // Link variant
...
export const Button = forwardRef(function Button(
  ...
  const classes = clsx(
    ...
    outline
      ...
      : plain
        ? styles.plain
        : // Ensure color access is safe even if color is optional on the union
          clsx(styles.solid, styles.colors[color ?? 'dark/zinc'])
  );

  // Check for 'to' prop instead of 'href'
  if ('to' in props && props.to !== undefined) {
    // Type assertion for the Link variant's props
    ...
    return (
      <Link
        {...linkProps} // Spread the asserted props
        className={classes}
  ...
  // Type assertion for the Button variant's props
  ...
  return (
    <Headless.Button
      {...buttonProps} // Spread the asserted props
      className={classes} // Keep cursor-default removed
